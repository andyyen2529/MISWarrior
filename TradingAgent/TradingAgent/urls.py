...
urlpatterns = [
    ...
    url(r'^ajax/addingHistory_waitOrHold', views.addingHistory_waitOrHold, name='addingHistory_waitOrHold'),
    url(r'^ajax/addingHistory_buyOrSell', views.addingHistory_buyOrSell, name='addingHistory_buyOrSell'),
    url(r'^ajax/history', views.history, name='history'),
